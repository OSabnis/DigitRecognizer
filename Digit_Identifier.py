# Digit Identifier using Convolutional Neural Networks on the MNIST Dataset
"""
Dataset Information:
    Files are hand drawn, grey scaled images from 0 to 9
    Training set has 42000 images with 785 columns holding pixel information
    Testing set has 28000 images with 784 columns holding pixel information
...
# SPLITTING THE TRAINING SET INTO X AND Y SETS FOR TRAINING
...
# RESHAPING THE DATASET FOR FITTING INTO THE NETWORK
X_Tr = x_train.reshape(x_train.shape[0],28,28,1)
X_Te = x_test.reshape(x_test.shape[0],28,28,1)


# CATEGORICAL VARIABLES AND SPLITTING TRAININGSET INTO TRAINING AND VALIDATION SETS
...
# CHECKING THE ERRORS AND VISUALIZING THE MAJOR ONES
...
# USING THE MODEL FOR CLASSIFICATION AND CREATING A SUBMISSION FILE
